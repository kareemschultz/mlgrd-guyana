...
export const seedMinisters: Minister[] = [
  ...
  },
  {
    ...
    portrait: asset("/official-placeholder-sukhai.svg"),
    initials: "PS",
  ...
  },
  {
    ...
    portrait: asset("/official-placeholder-persaud.svg"),
    initials: "AP",
    bio: "",
    termStart: "",
    termEnd: "",
...
export const seedGallery: GalleryItem[] = [
  ...
  },
  {
    ...
    caption: "The Minister engages Neighborhood Democratic Councils on their responsibilities to residents.",
